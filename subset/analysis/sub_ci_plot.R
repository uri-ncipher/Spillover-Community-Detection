...
alpha1 = cbind(c(cbind(
  direct_effect(sub_imp_cfg)[1,1], direct_effect(sub_imp_cfg)[2,1], direct_effect(sub_imp_cfg)[3,1]),
  indirect_effect(sub_imp_cfg, .60, .20)[,1],
  indirect_effect(sub_imp_cfg, .4, .20)[,1],
  indirect_effect(sub_imp_cfg, .60, .4)[,1],
  total_effect(sub_imp_cfg, .60, .20)[,1],
  total_effect(sub_imp_cfg, .4, .20)[,1],
  total_effect(sub_imp_cfg, .60, .4)[,1],
  overall_effect(sub_imp_cfg, .60, .20)[,1],
  overall_effect(sub_imp_cfg, .4, .20)[,1],
  overall_effect(sub_imp_cfg, .60, .4)[,1]))

alpha2 = cbind(c(cbind(
  direct_effect(sub_imp_cfg)[1,3], direct_effect(sub_imp_cfg)[2,3], direct_effect(sub_imp_cfg)[3,3]),
  indirect_effect(sub_imp_cfg, .60, .20)[,3],
  indirect_effect(sub_imp_cfg, .4, .20)[,3],
  indirect_effect(sub_imp_cfg, .60, .4)[,3],
  total_effect(sub_imp_cfg, .60, .20)[,3],
  total_effect(sub_imp_cfg, .4, .20)[,3],
  total_effect(sub_imp_cfg, .60, .4)[,3],
  overall_effect(sub_imp_cfg, .60, .20)[,3],
  overall_effect(sub_imp_cfg, .4, .20)[,3],
  overall_effect(sub_imp_cfg, .60, .4)[,3]))
...
Lbound01 = cbind(round(c(cbind(
  -direct_effect(sub_imp_cfg)[1,8], -direct_effect(sub_imp_cfg)[2,8], -direct_effect(sub_imp_cfg)[3,8]),
  indirect_effect(sub_imp_cfg, .60, .20)[,7],
  indirect_effect(sub_imp_cfg, .4, .20)[,7],
  indirect_effect(sub_imp_cfg, .60, .4)[,7],
  -total_effect(sub_imp_cfg, .20, .60)[,8],
  -total_effect(sub_imp_cfg, .20, .4)[,8],
  -total_effect(sub_imp_cfg, .4, .60)[,8],
  overall_effect(sub_imp_cfg, .60, .20)[,7],
  overall_effect(sub_imp_cfg, .4, .20)[,7],
  overall_effect(sub_imp_cfg, .60, .4)[,7]), 3))

Lbound1 = cbind(paste(rep("(", 12), Lbound01, sep = ""))

Ubound01 = cbind(round(c(cbind(
  -direct_effect(sub_imp_cfg)[1,7], -direct_effect(sub_imp_cfg)[2,7], -direct_effect(sub_imp_cfg)[3,7]),
  indirect_effect(sub_imp_cfg, .60, .20)[,8],
  indirect_effect(sub_imp_cfg, .4, .20)[,8],
  indirect_effect(sub_imp_cfg, .60, .4)[,8],
  -total_effect(sub_imp_cfg, .20, .60)[,7],
  -total_effect(sub_imp_cfg, .20, .4)[,7],
  -total_effect(sub_imp_cfg, .4, .60)[,7],
  overall_effect(sub_imp_cfg, .60, .20)[,8],
  overall_effect(sub_imp_cfg, .4, .20)[,8],
  overall_effect(sub_imp_cfg, .60, .4)[,8]), 3))
...
Lbound02 = cbind(round(c(cbind(
  -direct_effect(sub_imp_lec)[1,8], -direct_effect(sub_imp_lec)[2,8], -direct_effect(sub_imp_lec)[3,8]),
  indirect_effect(sub_imp_lec, .60, .20)[,7],
  indirect_effect(sub_imp_lec, .4, .20)[,7],
  indirect_effect(sub_imp_lec, .60, .4)[,7],
  -total_effect(sub_imp_lec, .20, .60)[,8],
  -total_effect(sub_imp_lec, .20, .4)[,8],
  -total_effect(sub_imp_lec, .4, .60)[,8],
  overall_effect(sub_imp_lec, .60, .20)[,7],
  overall_effect(sub_imp_lec, .4, .20)[,7],
  overall_effect(sub_imp_lec, .60, .4)[,7]), 3))

Lbound2 = cbind(paste(rep("(", 12), Lbound02, sep = ""))

Ubound02 = cbind(round(c(cbind(
  -direct_effect(sub_imp_lec)[1,7], -direct_effect(sub_imp_lec)[2,7], -direct_effect(sub_imp_lec)[3,7]),
  indirect_effect(sub_imp_lec, .60, .20)[,8],
  indirect_effect(sub_imp_lec, .4, .20)[,8],
  indirect_effect(sub_imp_lec, .60, .4)[,8],
  -total_effect(sub_imp_lec, .20, .60)[,7],
  -total_effect(sub_imp_lec, .20, .4)[,7],
  -total_effect(sub_imp_lec, .4, .60)[,7],
  overall_effect(sub_imp_lec, .60, .20)[,8],
  overall_effect(sub_imp_lec, .4, .20)[,8],
  overall_effect(sub_imp_lec, .60, .4)[,8]), 3))
...
png(filename = paste(ROOT, "/subset/store_outputs/sub_diff_ci.png", sep = ""), width = 550, height = 550)
